...
2. 学习这个东西对理解
  [维特根斯坦的理论](../逻辑哲学论分析/README.md)
  很有帮助，写出来可以作为那边的一个参考。

1. 学习这个东西对理解什么是
  [软件架构设计](../软件构架设计/README.md)
  很有帮助，写出来可以作为那边的一个参考。
